package Low_Level_Design.Problems.VendingMachine;

import Low_Level_Design.Problems.VendingMachine.entity.Inventory;
import Low_Level_Design.Problems.VendingMachine.entity.Item;
import Low_Level_Design.Problems.VendingMachine.enums.Coin;
import Low_Level_Design.Problems.VendingMachine.state.IdleState;
import Low_Level_Design.Problems.VendingMachine.state.VendingMachineState;

public class VendingMachine {
    private final static VendingMachine INSTANCE = new VendingMachine();
    private final Inventory inventory = new Inventory();
    private VendingMachineState currVendingMachineState;
    private int balance = 0;
    private String selectedItemCode;

    public VendingMachine(){
        currVendingMachineState = new IdleState(this);
    }
    ...
    public void insertCoin(Coin coin){
        currVendingMachineState.insertCoin(coin);
    }
    ...
    public void selectItem(String code){
        currVendingMachineState.selectItem(code);
    }

    public void dispense(){
        currVendingMachineState.dispense();
    }
    ...
    public void setState(VendingMachineState vendingMachineState) {
       this.currVendingMachineState = vendingMachineState;
    }
